...
CREATE TABLE EMPRUNT(
	...
	,CONSTRAINT EMPRUNT_date0_FK FOREIGN KEY (dateEmprunt) REFERENCES date(dateEmprunt)
	,CONSTRAINT EMPRUNT_EXEMPLAIRE1_FK FOREIGN KEY (noExemplaire) REFERENCES EXEMPLAIRE(noExemplaire)
)ENGINE=InnoDB;